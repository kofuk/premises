        ...
        return (
            <React.Fragment key={this.name}>
                <input type="radio" className="btn-check" id={`machineType_${this.name}`} name="machine-type"
                       autoComplete="off" value={this.name} checked={this.name === selectedValue}
...
const machines: Machine[] = [
    new Machine('2g', 2, 3, 3.3), new Machine('4g', 4, 4, 6.6),
    new Machine('8g', 8, 6, 13.2), new Machine('16g', 16, 8, 24.2),
    new Machine('32g', 32, 12, 48), new Machine('64g', 64, 24, 96.8)
];
